...
always@(*)begin
    case (valu_opcode_i)
        ...
        // VALU_OP_VMUL: begin
        //     valu_result_o[SEW-1:0] = 0;
        //     for (int i = 1; i < 9; i = i + 1) begin
        //         valu_result_o[SEW-1:0] += operand_v1_i[i*SEW -: SEW] * operand_v2_i[i*SEW -: SEW];
        //     end
        //     valu_result_o[VREG_DW-1:SEW]= {7*SEW{valu_result_o[SEW-1]}};
        // end
        default: begin
            valu_result_o = 512'h0;
        end
